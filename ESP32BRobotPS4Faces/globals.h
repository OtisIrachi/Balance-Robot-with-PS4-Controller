...
extern float resUpper;     
extern float resLower;      
extern float voltRef;       
extern float ADrange; 
...
//extern uint8_t speedMode;  // speedMode = 0 Normal mode, speedMode = 1 Pro mode (More agressive)
...
extern float LeftShoulder;
extern float JoyStickLftRgt;
extern float JoyStickForRev;
extern float Kp_user_Preset;
extern float Kd_user_Preset;
extern float Kp_thr_user_Preset;
extern float Ki_thr_user_Preset;
